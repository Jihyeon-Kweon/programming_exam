...
public class ChessMove {
    ...
    public ChessMove(ChessPosition startPosition, ChessPosition endPosition,
        ...
        if(startPosition == null || endPosition == null){
            throw new IllegalArgumentException("Start and end position cannot be null.");
        }
    ...
    public boolean equals(Object obj){
        ...
        return startPosition.equals(that.startPosition) &&
                ...
                (promotionPiece == null && that.promotionPiece == null) || (promotionPiece != null && promotionPiece.equals(that.promotionPiece));
    }
